...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2026 at 07:06 AM
...
INSERT INTO `book_copies` (`id`, `book_id`, `accession_number`, `status`, `is_purchased`, `purchase_price`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 'BK-374548', 'available', 1, 0.00, '2026-01-01 19:31:39', '2026-01-02 21:58:55', '2026-01-02 21:58:55'),
(2, 1, 'BK-999919', 'available', 1, 0.00, '2026-01-01 19:31:39', '2026-01-02 03:03:45', NULL),
(3, 1, 'BK-372783', 'available', 1, 0.00, '2026-01-01 19:31:39', '2026-01-02 03:06:50', NULL),
(4, 1, 'BK-161976', 'available', 1, 0.00, '2026-01-01 19:31:39', '2026-01-02 05:55:08', NULL),
(5, 1, 'BK-694201', 'borrowed', 1, 0.00, '2026-01-01 19:31:39', '2026-01-02 03:07:09', NULL);
...
(13, 8, 4, '2026-01-02 11:07:30', '2025-12-01 11:07:30', '2026-01-02 13:55:08', 160.00, '2026-01-02 03:07:30', '2026-01-02 05:55:08');
...
(2, 'PCIS00059', 'Nikko Calumpiano', 'itsupport@pcis.edu.ph', 'avatars/x9fpNOboB0Tgs131ys3JPbYUAPbVx73g6hsJf6Zr.jpg', 'admin', NULL, '$2y$10$Bh7Mp/eTd0kOiC7HRYfDGeNgmxn0Afog/EPX2gvwDkmQ7wZAihU0G', NULL, '2026-01-01 21:33:43', '2026-01-02 04:00:50'),
...
(8, 'IB0001', 'Gabriel Gerard Dela Cruz', 'gabrielgerarddelacruz@pcis.edu.ph', 'avatars/b8nczzsmF2XQwU548x9HJ9tpLVOLU1JBNGAGRPzK.png', 'member', NULL, '$2y$10$.EQ1AhIvBk1rvQDoZkyhGOkwo6cBLVlKZD9OZnaLSSPj7pjnxIKQC', NULL, '2026-01-02 03:01:07', '2026-01-02 03:52:28'),
(9, 'IB0004', 'Levi Caden Abalos', 'levicadenabalos@pcis.edu.ph', 'avatars/doZlc2ySjBErBGyNh2TCZXhocGVCkVvM5RJ7JvjJ.png', 'member', NULL, '$2y$10$rnC8A90f9qTcqsMopQcus.RyAuTcVL2Oky9hGF0JaW9ZS/C1XznPG', NULL, '2026-01-02 03:05:30', '2026-01-02 03:52:20');
